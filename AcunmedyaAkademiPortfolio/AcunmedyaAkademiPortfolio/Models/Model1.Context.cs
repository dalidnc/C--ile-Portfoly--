...
namespace AcunmedyaAkademiPortfolio.Models
{
    ...
    public partial class DbAcunMedyaAkedemiPortfolioEntities : DbContext
    {
        public DbAcunMedyaAkedemiPortfolioEntities()
            : base("name=DbAcunMedyaAkedemiPortfolioEntities")
        {
        }
